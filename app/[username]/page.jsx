...
//     <li><a href="mailto:hello@rizkypratama.dev" className={`${styles.btn} ${styles.btn_primary}`} >Kontak →</a></li>
//   </ul>
// </nav>
...
//         <span className={styles.social_handle}>@rizkypratama</span>
//       </a>
...
//         <span className={styles.social_handle}>@rizkypratama_</span>
//       </a>
...
//         <span className={styles.social_handle}>Rizky Pratama</span>
//       </a>
...
//         <span className={styles.social_handle}>@rizkypratama.dev</span>
//       </a>
...
//       <h4>Kontak</h4>
//       <ul className={styles.footer_links}>
//         <li><a href="mailto:hello@rizkypratama.dev">hello@rizkypratama.dev</a></li>
...
//     <p className={styles.footer_copy}>© 2025 <span>Rizky Pratama</span> — Dibuat dengan ☕ & terlalu banyak caffeine</p>
...
export default function Home() {
  return (
    <>
      <Head>
        <title>Rizky Pratama — Developer & Designer</title>
      </Head>
